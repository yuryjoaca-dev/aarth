    ...
    <>
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1920&q=80" alt="Basement renovation" fill className="object-cover" priority />
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
          <motion.div initial="hidden" animate="show" variants={stagger(0.12)}>
            ...
            <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl font-black mb-5 tracking-tight leading-none">Basements</motion.h1>
            <motion.p variants={fadeUp} className="text-xl text-slate-300 leading-relaxed">Transforming unused spaces into modern living areas.</motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} variants={stagger(0.1)}>
          <div className="text-center mb-12">
            ...
            <motion.h2 variants={fadeUp} className="text-4xl font-black tracking-tight text-slate-900 mb-6">Basements That Add Value</motion.h2>
            <motion.p variants={fadeUp} className="text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">
              From cozy family rooms to fully equipped suites, we transform basements
              into functional and stylish living spaces. Waterproofing, lighting, and
              smart layouts ensure comfort and durability.
            </motion.p>
          </div>
          <motion.div variants={stagger(0.07)} className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
            {["Full Basement Finishing", "Home Theatre Rooms", "Guest Suites", "Wet Bars", "Waterproofing", "Egress Windows"].map((f) => (
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} variants={stagger(0.1)}>
            ...
            <motion.h2 variants={fadeUp} className="text-4xl font-black tracking-tight text-center text-slate-900 mb-12">Basement Gallery</motion.h2>
            <motion.div variants={stagger(0.08)} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {gallery.map((src, i) => (
                <motion.div key={i} variants={fadeUp} className="relative aspect-[4/3] rounded-3xl overflow-hidden group shadow-xl shadow-slate-200/60">
                  <Image src={src} alt={`Basement ${i + 1}`} fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
      ...
      <section className="bg-gradient-to-br from-[#0f2557] via-[#1a3a7a] to-[#091a3e] text-white py-28 px-6 relative overflow-hidden">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} variants={stagger(0.12)}
          ...
          <motion.h2 variants={fadeUp} className="text-4xl font-black tracking-tight mb-4">Ready to finish your basement?</motion.h2>
