...
export default function RestaurantsPage() {
  return (
    <>
      <SEO title="Restaurant & Hospitality Renovations Edmonton" description="Restaurant and hospitality construction in Edmonton. Kitchen fit-outs, dining areas, bar construction, ventilation, health code compliance. Free quotes." url="/commercial/restaurants" />
