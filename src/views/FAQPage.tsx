        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/contact" className="inline-flex items-center justify-center gap-2 bg-[#C9963B] hover:bg-[#A67A2E] text-white font-medium px-7 py-3.5 text-xs uppercase tracking-widest transition-all duration-200" style={{ fontFamily: 'Inter, sans-serif' }}>
