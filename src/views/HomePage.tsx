        ...
        >
          ...
          <div className="max-w-3xl">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-3">
              <Link href="/contact" className="inline-flex items-center justify-center gap-2 border border-[#C9963B] text-[#C9963B] hover:bg-[#C9963B] hover:text-white font-medium px-8 py-3.5 text-xs uppercase tracking-widest transition-all duration-300" style={{ fontFamily: 'Inter, sans-serif' }}>
                Get a Free Quote <ArrowRight className="w-3.5 h-3.5" />
              </Link>
              <Link href="/projects" className="inline-flex items-center justify-center gap-2 border border-white/25 hover:border-white/50 text-white font-medium px-8 py-3.5 text-xs uppercase tracking-widest transition-all duration-300" style={{ fontFamily: 'Inter, sans-serif' }}>
                View Our Work
              </Link>
            </motion.div>
          </div>
            ...
            {[
              ...
              <motion.div key={card.title} variants={fadeUp} className="relative overflow-hidden group h-96">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <Link href={card.href} className="inline-flex items-center gap-2 border border-[#C9963B] text-[#C9963B] hover:bg-[#C9963B] hover:text-white px-5 py-2.5 text-xs uppercase tracking-widest font-medium transition-all duration-200" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            {services.map((item) => (
              <motion.div key={item.title} variants={fadeUp} className={`relative overflow-hidden group ${item.wide && item.tall ? "lg:col-span-2 lg:row-span-2" : item.wide ? "lg:col-span-2" : ""}`}>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <Link href={item.link} className="inline-flex items-center gap-1.5 text-[#C9963B] font-medium text-xs uppercase tracking-widest" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <section className="bg-[#080808] text-white py-28 px-6 relative overflow-hidden">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} variants={stagger(0.12)} className="relative max-w-3xl mx-auto text-center">
          ...
          <motion.div variants={fadeUp}>
            <Link href="/contact" className="inline-flex items-center gap-2 border border-[#C9963B] text-[#C9963B] hover:bg-[#C9963B] hover:text-white font-medium px-10 py-4 text-xs uppercase tracking-widest transition-all duration-300" style={{ fontFamily: 'Inter, sans-serif' }}>
              Get a Free Quote <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </motion.div>
        </motion.div>
