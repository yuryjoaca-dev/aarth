  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/contact", {
        ...
        body: JSON.stringify({ ...formData, message: `Landing page lead — Project: ${formData.projectType}` }),
      });
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {services.map(s => (
              <Link key={s.name} href={s.link} className="relative overflow-hidden group aspect-square block">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-8">
            <Link href="/projects" className="inline-flex items-center gap-2 text-[#C9963B] font-semibold hover:underline">
