...
const features = [
  { title: 'Kitchen Fit-Outs', desc: "Commercial kitchen construction built to your chef's specifications and health code requirements." },
  { title: 'Dining Areas', desc: 'Atmospheric dining rooms designed to create the perfect guest experience for your concept.' },
  { title: 'Bar & Counter Construction', desc: 'Custom bars, counters, and service stations built for function and visual impact.' },
  { title: 'Ventilation', desc: 'Commercial HVAC and ventilation systems coordinated with certified mechanical contractors.' },
  { title: 'Health Code Compliance', desc: 'We build to Alberta Health Services standards — inspections and occupancy permits included.' },
  { title: 'Patio & Exterior', desc: 'Outdoor dining patios, pergolas, and exterior finishes that extend your guest experience.' },
]
const stats = [
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <motion.div initial="hidden" animate="show" variants={stagger(0.12)} className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <motion.h1 variants={fadeUp} className="text-5xl lg:text-7xl font-bold text-white mt-2 mb-6 leading-none tracking-tight">
            Restaurants &<br /><em className="not-italic text-[#C9963B]">Hospitality</em>
          </motion.h1>
          <motion.p variants={fadeUp} className="text-white/75 text-base max-w-2xl mx-auto leading-relaxed mb-10 font-light" style={{ fontFamily: 'Inter, sans-serif' }}>
            We build restaurants and hospitality venues that create unforgettable guest experiences — from kitchen to dining room to patio.
          </motion.p>
          <motion.div variants={fadeUp}>
            <Link href="/contact" className="inline-flex items-center gap-2 border border-[#C9963B] text-[#C9963B] hover:bg-[#C9963B] hover:text-white font-medium px-8 py-3.5 text-xs uppercase tracking-widest transition-all duration-300" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} variants={stagger(0.1)} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight mb-6">Built to serve, built to impress</motion.h2>
              <motion.p variants={fadeUp} className="text-slate-500 text-sm leading-relaxed mb-4 font-light" style={{ fontFamily: 'Inter, sans-serif' }}>
                Restaurant construction is uniquely complex — health codes, commercial kitchen specs, fire suppression, ventilation, and front-of-house design all need to work together seamlessly. We've done it before, and we do it right.
              </motion.p>
              <motion.p variants={fadeUp} className="text-slate-500 text-sm leading-relaxed mb-8 font-light" style={{ fontFamily: 'Inter, sans-serif' }}>
                We manage the entire project from permits through to final health inspection, so you can focus on your concept rather than the construction. Fast-tracked schedules available for time-sensitive openings.
              </motion.p>
              <motion.div variants={fadeUp}>
                <Link href="/contact" className="inline-flex items-center gap-2 bg-[#111111] hover:bg-[#1c1c1c] text-white font-medium px-7 py-3.5 text-xs uppercase tracking-widest transition-all duration-200" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} variants={stagger(0.1)} className="text-center mb-14">
            ...
            <motion.h2 variants={fadeUp} className="text-4xl font-bold text-slate-900 tracking-tight">Restaurant Projects</motion.h2>
          </motion.div>
